...
import { FolderGit2, Trash2, X } from 'lucide-react';
            ...
            <ul className="board-settings__repos">
              {repos.map((r) => (
                <li key={r.id} className="board-settings__repo">
                  {/* One glyph for both providers, as the design's PR chip does: lucide
                      1.x dropped brand logos, and the URL beside it names the host. */}
