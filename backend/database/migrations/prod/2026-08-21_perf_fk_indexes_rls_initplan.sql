...
--    of the 2026-08-21 advisor pass that found them first. The staging notes below
--    ("safe anytime", "re-run after the group-messaging migration") predate
--    that and no longer apply.
-- ═══════════════════════════════════════════════════════════════════════════
