...
router.post('/{project_id}/create_tsr')(views.create_tsr)
router.get('/{project_id}/view_tsrs')(views.view_tsrs)
router.get('/{project_id}/tsrs/submitted')(views.get_submitted_tsrs)
router.get('/{project_id}/tsrs/received')(views.get_received_tsrs)