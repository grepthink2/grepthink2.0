...
router.get('/projects/{project_id}/scrum/repos')(views.list_repos)
router.post('/projects/{project_id}/scrum/repos')(views.add_repo)
router.delete('/scrum/repos/{repo_id}')(views.delete_repo)
