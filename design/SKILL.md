---
name: grepthink-design
description: Use this skill to generate well-branded interfaces and assets for GrepThink (team & project management for UCSC CSE 115A/B/C), either for production or throwaway prototypes/mocks/etc. Contains essential design guidelines, colors, type, fonts, assets, and UI kit components for prototyping.
user-invocable: true
---
